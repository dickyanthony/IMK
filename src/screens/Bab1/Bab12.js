    ...
    <div>
      ...
      <div className="row">
        <p className="paragraph">
          ...
          aspek terkait (Hewett, et az, 1992, 1996). Dari perspektif ilmu
          kompüter, fokus İMK adalah pada interaksi, khususnya interaksi antara
          ...
          maşukan/keluaran, dan lingkungan kerja. Istilah "interaksi manusia dan
          kompüter” atau "interaksi manusia dan meşin” melingkupi dua sisi,
          yaitu meşin dan manusia. Pertama kita perlu melihat istilah "meşin”.
          istilah meşin lebih populer dengan sebutan kompüter. Berbagai jenis
          kompüter yang kita kenal antara lain adalah mainframe, workstation,
          dan komputer pribadi. Komputer pribadi biasanya dalam bentuk komputer
          meja, atau komputer jinjing/pangku Selain berbagai jenis di atas,
          ...
          sebuah organisasi, maka antarmuka di sini termasuk di dalamnya antara
          lain sistem terdistribusi, komunikasi antar manusia terbantu komputer,
          atau suatu pekerjaan yang secara kooperatif dikerjakan oleh sekelompok
          orang yang menggunakan bantuan sistem komputer. Kesemuanya ini
          merupakan topik penting dalam ruang lingkup IM K. Jika kita melangkah
          ...
          mereka dari kantor mereka karena adanya otomasi kantor sering menjadi
          bahan yang menarik untuk didiskusikan. Perancangan grafis dan
          ...
          tampilan, penggunaan layar sentuh semakin popular. Penggunaan layer
          sentuh, beserta teknologi di belakang nya, telah menjadi bahan kajian
          yang menarik. Saat ini, selain layar sentuh, layar sentuh banyak
          (multitouch screen) juga semakin banyak digunakan. Lebih lanjut, dari
          sudut pandang ilmu komputer, disiplin ilmu yang disebutkan di atas
          dapat menjadi semacam pendukung IMK, seperti halnya fisika menjadi
          pendukung disiplin teknik sipil, atau teknik mesin yang menjadi
          ...
          demikian, dari sudut pandang ilmu komputer secara langsung, adalah
          perlu untuk membahas IMK secara luas untuk memberikan bekal kepada
          mahasiswa (dan praktisi) untuk menghindari kelemahan klasik yang
          memisahkan antara rancangan dengan konteks. Selain itu perlu juga
          diketahui bahwa IMK berurusan dengan kinerja gabungan antara manusia
          dan mesin; struktur komunikasi antara manusia dan mesin, kemampuan
          manusia menggunakan mesin (termasuk kemampuan untuk
          dipelajari//earnability dari antarmuka yang digunakan); algoritma dan
          pemrograman antarmuka; isu-isu rekayasa yang muncul pada saat
