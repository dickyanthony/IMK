    ...
    <div>
      ...
      <div className="row">
        <p className="paragraph font-sans">
          ...
          kali mendengar istilah di atas barangkali akan bingung, tidak mengerti
          akan arti dari kedua istilah tersebut. Tetapi, sejalan dengan
          pengalaman Anda mengoperasikan perangkat lunak atau program aplikasi,
          secara tidak Anda sadari istilah-istilah di atas akan merasuk ke dalam
          kumpulan kosa kata yang telah Anda miliki sebelumnya. Pertanyaan yang
          timbul adalah: Sebenarnya apa yang dimaksud dengan istilah ramah
          dengan pengguna, WYSIWYG, dan beberapa istilah "serem" yang Iain?
          Istilah "ramah dengan pengguna" digunakan untuk merujuk kepada
          karakteristik yang dimiliki oleh perangkat lunak atau program aplikasi
          ...
          menyelesaikan suatu pekerjaan dengan hasil yang sesuai keinginan, juga
          menyediakan berbagai kemudahan pada saat dia mengoperasikan program
          yang dimaksud. Dengan demikian tuntutan bahwa sebuah program aplikasi
          harus bersifat ramah sesungguhnya juga datang dari pengguna.
        </p>
